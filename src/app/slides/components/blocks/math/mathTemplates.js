...
export const MATH_TEMPLATES = {
  ...
  superscript: {
    ...
    keywords: ["superscript", "power", "exponent", "superscript"],
    category: "Powers",
    latex: "!0^{!1}",
    placeholders: ["x", "n"],
    cursorAt: 1,
  ...
  square: {
    ...
    keywords: ["square", "power", "exponent", "squared"],
    category: "Powers",
    latex: "!0^{2}",
    placeholders: ["x"],
    cursorAt: 0,
  ...
  cube: {
    id: "cube",
    description: "Cube (x³)",
    keywords: ["cube", "power", "exponent", "cubed"],
    category: "Powers",
    latex: "!0^{3}",
    placeholders: ["x"],
    cursorAt: 0,
  ...
  subscript: {
    ...
    keywords: ["subscript", "index", "sub", "base"],
    category: "Subscripts",
    latex: "!0_{!1}",
    placeholders: ["x", "n"],
    cursorAt: 1,
